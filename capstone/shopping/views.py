...
def profile_view(request, name):
    ...
    return render(request, "shopping/profile.html", {
        ...
        "has_reviews": check_other_users_have_reviewed(
...
def check_other_users_have_reviewed(user, review_list):
    for review in review_list:
        if review.listing in Listing.objects.filter(user=user) and review.user != user:
            return True
    return False
